package com.hu.quiznebula.service.impl;
...
import com.hu.quiznebula.constant.CommonConstant;
import com.hu.quiznebula.exception.ThrowUtils;
import com.hu.quiznebula.mapper.ScoringResultMapper;
import com.hu.quiznebula.model.dto.scoringResult.ScoringResultQueryRequest;
import com.hu.quiznebula.model.entity.App;
import com.hu.quiznebula.model.entity.ScoringResult;
import com.hu.quiznebula.model.entity.User;
import com.hu.quiznebula.model.vo.ScoringResultVO;
import com.hu.quiznebula.model.vo.UserVO;
import com.hu.quiznebula.service.AppService;
import com.hu.quiznebula.service.ScoringResultService;
import com.hu.quiznebula.service.UserService;
import com.hu.quiznebula.utils.SqlUtils;
...
public class ScoringResultServiceImpl extends ServiceImpl<ScoringResultMapper, ScoringResult> implements ScoringResultService {
    ...
    public void validScoringResult(ScoringResult scoringResult, boolean add) {
        ...
        if (add) {
            //补充校验规则
            ThrowUtils.throwIf(StringUtils.isBlank(resultName), ErrorCode.PARAMS_ERROR,"结构名称不能为空");
        }
        // 修改数据时，有参数则校验
        // 补充校验规则
        if (StringUtils.isNotBlank(resultName)) {
            App app=appService.getById(appId);
            ThrowUtils.throwIf(app==null, ErrorCode.PARAMS_ERROR, "App非法");
            ThrowUtils.throwIf(resultName.length() > 80, ErrorCode.PARAMS_ERROR, "题目名称过长");
        }
    }
