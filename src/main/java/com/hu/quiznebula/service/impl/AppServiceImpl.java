...
import com.hu.quiznebula.controller.AppController;
import com.hu.quiznebula.exception.ThrowUtils;
import com.hu.quiznebula.mapper.AppMapper;
import com.hu.quiznebula.model.dto.app.AppQueryRequest;
import com.hu.quiznebula.model.entity.App;
import com.hu.quiznebula.model.entity.User;
import com.hu.quiznebula.model.enums.AppScoringStrategyEnum;
import com.hu.quiznebula.model.enums.AppTypeEnum;
import com.hu.quiznebula.model.enums.ReviewStatusEnum;
import com.hu.quiznebula.model.vo.AppVO;
...
public class AppServiceImpl extends ServiceImpl<AppMapper, App> implements AppService {
    ...
    public void validApp(App app, boolean add) {
        ...
        if (add) {
            ...
            ThrowUtils.throwIf(StringUtils.isBlank(appDes), ErrorCode.PARAMS_ERROR, "应用描述不能为空");
    ...
    public QueryWrapper<App> getQueryWrapper(AppQueryRequest appQueryRequest) {
        ...
        // 精确查询
        queryWrapper.eq(ObjectUtils.isNotEmpty(notId), "appIcon", appIcon);
